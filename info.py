...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6248675084').split()] # For Multiple Id Use One Space Between Each.
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '6248675084').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002735488128') # give your force subscribe channel id here else leave it blank
...
reqst_channel = environ.get('REQST_CHANNEL', '-1002840072156') # This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None 
support_chat_id = environ.get('SUPPORT_CHAT_ID', '8396141777') # This Is Your Bot Support Group Id , Here Bot Will Not Give File Because This Is Support Group.
...
MSG_ALRT = environ.get('MSG_ALRT', 'zoro_team_bot')
